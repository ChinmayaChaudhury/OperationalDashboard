sap.ui.define([
	...
	return Controller.extend("order-monitor.controller.OrderList", {
		onInit: function() {
			this.parameters = {
			...
			this._loadData(`${this.getOwnerComponent().getManifestEntry("/sap.app/dataSources/order-list/uri")}`, "order-list");
		},
		
		onAfterRendering: function() {},
		
		goToDetails: function(evt) {
			const order = evt.getSource();
			const router = sap.ui.core.UIComponent.getRouterFor(this);
			
			router.navTo("order-details", {
